            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Item {
                        ...
                        readonly property int seatReserve: 200
                        ...
                        /// Shrink community cards when the drill panel is narrower than the intrinsic strip (avoids clip).
                        ...
                        readonly property real boardStripScale: Math.min(1.0, Math.max(0.32,
                                (drillArea.width - 20) / Math.max(1, flopStripIntrinsic)))
