                ...
                Rectangle {
                    ...
                    Item {
                        ...
                        readonly property real boardStripScale: Math.min(1.0, Math.max(0.24,
                                (drillArea.width - 2 * Theme.trainerPanelPadding) / Math.max(1, riverStripIntrinsic)))
                        ...
                        ColumnLayout {
                            ...
                            Item {
                                ...
                                Item {
                                    id: trainerSeatWrap
                                    width: Math.min(Math.round(218 * riverSeatRow.seatUiScale),
                                            parent.width > 0 ? parent.width : 99999)
                                    height: Math.round(312 * riverSeatRow.seatUiScale)
                                    anchors.horizontalCenter: parent.horizontalCenter

                                    Player {
                                        anchors.fill: parent
                                        uiScale: riverSeatRow.seatUiScale
                                        seatIndex: 0
                                        name: qsTr("You")
                                        position: "BTN"
