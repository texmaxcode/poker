...
Page {
    ...
    Component.onCompleted: {
        ...
        const ok = trainer.loadTurnSpots("qrc:/assets/training/spots_turn_v1.json")
        page.assetLoadFailed = !ok
        if (!ok) {
            statusLine = qsTr("Could not load turn spots.")
            return
        }
        trainer.startTurnDrill("srp_btn_bb")
    }
    ...
    function next() {
        cancelPendingAdvance()
        const q = trainer.nextTurnQuestion()
    ...
    function submit(a) {
        ...
        decisionSecLeft = 0
        decisionDeadlineMs = 0
        const r = trainer.submitTurnAnswer(a)
    ...
    Item {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                readonly property int _hudReserveQuantized: Math.max(172, Math.ceil(turnExerciseHud.height / 4) * 4)
                ...
                Text {
                    ...
                    text: qsTr("Turn spots failed to load. The bundled JSON asset may be missing or invalid.")
                ...
                Rectangle {
                    ...
                    Item {
                        ...
                        readonly property real drillScale: {
                            ...
                            var wScale = (Math.max(1, drillArea.width) - 24) / Math.max(1, turnStripIntrinsic)
                        ...
                        ColumnLayout {
                            ...
                            Column {
                                ...
                                Rectangle {
                                    ...
                                    width: turnPotBanner.implicitWidth + 22
                                    height: turnPotBanner.implicitHeight + 12
                                    radius: 8
                                    color: Theme.hudBg1
                                    ...
                                    Text {
                                        ...
                                        transform: Scale {
                                            id: turnTrainerPotValueScale
                                            origin.x: turnPotBanner.width * 0.5
                                            origin.y: turnPotBanner.height * 0.5
                                            xScale: 1
                                            yScale: 1
                                        }
                                    }
    ...
    Item {
        ...
        SequentialAnimation {
            ...
            ParallelAnimation {
                NumberAnimation {
                    target: turnTrainerPotValueScale
                    property: "xScale"
                    to: 1.08
                    duration: 95
                    easing.type: Easing.OutCubic
